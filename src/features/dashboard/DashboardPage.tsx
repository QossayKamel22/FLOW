      ...
      {loading ? (
        ...
        <>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 20 }}>
            <KpiCard label="New Leads" value={String(leads.items.length)} icon="🎯" trend={leads.items.length ? "Live from your data" : undefined} />
            <KpiCard label="Active Deals" value={String(activeDeals.length)} icon="💼" />
            <KpiCard label="Follow-ups" value={String(openFollowups.length)} icon="⏰" />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16 }}>
            <Card>
              ...
              <h3 style={{ fontWeight: 800, fontSize: 16, marginBottom: 4 }}>AI Briefing</h3>
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
                <Link to="/app/copilot" style={{ textDecoration: "none" }}>
                  <Button size="sm" variant="secondary" type="button">View Recommendations</Button>
                </Link>
                <Link to="/app/copilot" style={{ textDecoration: "none" }}>
