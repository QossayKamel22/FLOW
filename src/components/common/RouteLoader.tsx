  ...
  return (
    ...
    >
      <div style={{ position: "relative", width: 60, height: 60 }}>
        ...
        />
        <svg width="60" height="60" viewBox="0 0 100 100" style={{ position: "absolute", inset: 0 }} aria-hidden="true">
        ...
        <img
          src="/logo.svg"
          alt=""
          style={{ position: "absolute", inset: 0, margin: "auto", width: 30, height: 30, animation: "loadingBreathe 1s ease-in-out infinite" }}
        />
      </div>
      <style>{`
